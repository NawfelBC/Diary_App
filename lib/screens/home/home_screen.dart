...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        title: 'Diary',
        theme: new ThemeData(
            scaffoldBackgroundColor: Color.fromRGBO(24, 24, 24, 2)),
        home: Scaffold(
          appBar: AppBar(
                          ...
                          Transform.translate(
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    primary: Color.fromRGBO(102, 124, 111, 2)),
                                onPressed: () async => [
                                      ...
                                      children: <Widget>[
                                        Text('Image successfully uploaded !',
                                            style: GoogleFonts.aleo(
                                                color: Colors.white,
                                                fontSize: 14)),
                                        Image.network(finalurl, width: 30)
                                      ]),
                                  offset: Offset(0, -35))
                              : Text('')),
                      Center(
                                                                ...
                                                                ? GestureDetector(
                                                                    onTap: () {
                                                                      Navigator
                                                                        ...
                                                                        MaterialPageRoute(
                                                                            builder: (context) =>
                                                                                new ProfileScreen(currentUsername: currentUsername, currentProfileurl: currentProfileurl)),
                                                                        (Route<dynamic>
                                                                                route) =>
                                                                            false,
                                                                      );
                                                                    ...
                                                                    child: ClipRRect(
                                                                        ...
                                                                        child: Image.network(docData['profileurl'], width: 40)))
                                                                : Image.network('https://rohsco.rqoh.com/wp-content/uploads/sites/9/2019/09/default-profile.png', width: 40),
                                                        title: Text(
                                                            '\n' + username,
                                                            style: TextStyle(
                                                                fontSize: 16,
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          actions: <
                                                                            ...
                                                                            TextButton(
                                                                                onPressed: () {
                                                                                  if (finalurl != null) {
                                                                                    FirebaseFirestore.instance.collection(idofuser).doc(snapshot.data!.docs[index].id).update({
                                                                                      'text': _textFieldController.text,
                                                                                      'imageUrl': finalurl,
                                                                                      'edited': 'Y'
                                                                                    });
                                                                                    FirebaseFirestore.instance.collection('all_posts').doc(snapshot.data!.docs[index].id).update({
                                                                                      'text': _textFieldController.text,
                                                                                      'imageUrl': finalurl,
                                                                                      'edited': 'Y'
                                                                                    });
                                                    ...
                                                    ? GestureDetector(
                                                        onTap: () {
                                                          Navigator
                                                            ...
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => new UsersScreen(
                                                                    currentUserId:
                                                                        userId,
                                                                    currentProfileurl:
                                                                        urlProfile,
                                                            ...
                                                            child: ClipRRect(
                                                                borderRadius:
                                                                    BorderRadius.circular(
                                                                        12.0),
                                                                child:
                                                                    Image.network(docData['profileurl'],
                                                                        width:
                                                                            40)))
                                                        : Image.network(
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        content:
                                                                          ...
                                                                          controller:
                                                                              _ReportController,
                                                                          decoration:
                                                                              InputDecoration(hintText: "What's the problem ?"),
                                                                        ),
                                                                        actions: <
                                                                            Widget>[
                                                                          TextButton(
                                                                              ...
                                                                              onPressed: () {
                                                                                setState(() {
                                                                                  ...
                                                                                  FirebaseFirestore.instance.collection('reported_posts').add({
                                                                                    'post': snapshot.data!.docs[index].id,
                                                                                    'reported_by': idofuser,
...
Future<String> getProfileurl(String id) async {
  var profileurl;
  DocumentSnapshot ds =
      await FirebaseFirestore.instance.collection(id).doc('profileurl').get();
